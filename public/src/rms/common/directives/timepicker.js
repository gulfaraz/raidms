    ...
    .directive("timepicker", ["$parse", "$log", "timepickerConfig", "$locale", function ($parse, $log, timepickerConfig, $locale) {
        return {
            ...
            "link" : function (scope, element, attrs, ngModel) {
                ...
                scope.$watch(scope.timezone, function () {
                    refresh("h");
                    refresh("m");
                });

                var selected = moment().tz(scope.timezone),
                ...
                ngModel.$render = function () {
                    var date = ngModel.$modelValue ? moment.tz(ngModel.$modelValue, scope.timezone) : null;
                ...
                function refresh(keyboardChange) {
                    makeValid();
                    ngModel.$setViewValue( moment.tz(selected, scope.timezone) );
